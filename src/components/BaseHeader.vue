...
<template>
  <nav class="bg-slate-200 border-gray-200 sticky top-0 z-20 dark:bg-gray-900">
    <div class="max-w-screen-2xl m-auto flex items-center p-4">
      <div class="header-left w-full flex justify-between  md:items-center ">
        <a href="https://flowbite.com/" class="flex items-center">
          <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="Flowbite Logo" />
          <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Zhangdodo</span>
        </a>
        ...
        <!-- 导航菜单 -->
        <div class="hidden w-full md:block md:w-auto md:flex-auto md:ml-12" id="navbar-default">
          <ul
            class="text-lg flex flex-col p-4 md:p-0 mt-4 border bg-slate-200 border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="#"
      ...
      <!-- 搜索框 -->
      <form class="w-50 hidden lg:block">
        ...
        <div class="relative">
          ...
          <input type="search" id="default-search"
            class="block w-full p- pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
